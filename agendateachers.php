...
<html>
    <head>
        ...
        <link href="./css/agendaTeachers.css" rel="stylesheet" type="text/css"/>
        <meta content="Launchpad by Anima" name="author">
        </meta>
    </head>
    <body style="margin: 0;
 background: rgba(255, 255, 255, 1.0);">
        <input id="anPageName" name="page" type="hidden" value="agendateachers"/>
        <div class="agendateachers">
                ...
                <div class="group22">
                    <div class="group21">
                        ...
                        <div class="group7">
                            ...
                            <div class="group65">
                                <div class="lireenfancepage1">
                                    Lire Enfance, page 11 - 15
                                </div>
                                <div class="donn351le51119">
                                    Donné le 5/11/19
                                </div>
                                <div class="pourle81119">
                                    Pour le 8/11/19
                                </div>
                                <div class="pourle51119">
                                    Pour le 5/11/19
                                </div>
                                <div class="pourle31119">
                                    Pour le 3/11/19
                                </div>
                                <div class="pourle21119">
                                    Pour le 2/11/19
                                </div>
                                <div class="pourle11119">
                                    Pour le 1/11/19
                                </div>
                                <div class="pourle301119">
                                    Pour le 30/11/19
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="group6">
                        <div class="finirfiche05surm">
                            Finir fiche 05 sur Marguerite Dur…
                        </div>
                        <div class="donn351le301019">
                            Donné le 30/10/19
                        </div>
                    </div>
                    <div class="group61">
                        <div class="fichemethode01ac">
                            Fiche Methode 01 a completer
                        </div>
                        <div class="donn351le251019">
                            Donné le 25/10/19
                        </div>
                    </div>
                    <div class="group62">
                        <div class="sujetder351flexion">
                            Sujet de réflexion, litterature
                        </div>
                        <div class="donn351le31119">
                            Donné le 3/11/19
                        </div>
                    </div>
                    <div class="group63">
                        <div class="r351dactionsujetdist">
                            Rédaction sujet distribué en clas…
                        </div>
                        <div class="donn351le21119">
                            Donné le 2/11/19
                        </div>
                    </div>
                    <div class="group64">
                        <div class="apprendrele347ongram">
                            Apprendre leçon grammaire clas…
                        </div>
                        <div class="donn351le11119">
                            Donné le 1/11/19
                        </div>
                    </div>
                    <div class="vousnu2019aviezpasenc">
                        Vous n’aviez pas encore donne <br />de devoirs a cette classe
                    </div>
                </div>
            </div>
        </div>
