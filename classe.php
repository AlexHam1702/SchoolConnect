...
<html>
    <head>
					<title>SchoolConnect | Classe</title>
 ...
 background: rgba(255, 255, 255, 1.0);">
        <input id="anPageName" name="page" type="hidden" value="classe"/>
        <div class="classe">
            <div style="width: 1280px; height: 100%; position:relative; margin:auto;">
                <div class="group27">
                    <img anima-src="./img/classe-rectangle.png" class="rectangle" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                ...
                <div class="group19">
                    <img anima-src="./img/classe-rectangle-3.png" class="rectangle" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                </div>
                <img anima-src="./img/classe-group-3.png" class="group3" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                <div class="group10">
                ...
                <div class="group12">
                    ...
                    <div class="label2">
                        <form action="minichat_post_classe.php" method="post" style="margin-top: 6.5px;">
																								<input type="text" name="message" id="message" placeholder="Message" />
																								<input type="text" name="chatpseudo" value="<?=$nickname?>" />
                                                                                                <input type="text" name="classchat" value="<?=$classe?>" style="width: 0px;height: 0px;padding-left: 0px;padding-right: 0px;"/>
																								<input type="submit" value="Envoyer" style="margin-left: 193px;"/>
																							</form>
...
?> </div>
                    <img anima-src="./img/classe-line@2x.png" class="line" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==" style="margin-top: 5px;"/>
                </div>
                <div class="semainedu1209au">
                    Semaine du 12/09 au 15/09
                </div>
                <img anima-src="./img/classe-arrow-left-1@2x.png" class="arrowleft" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                <img anima-src="./img/classe-arrow-left-1@2x.png" class="arrowleft1" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                <div class="group13">
                    <img anima-src="./img/classe-oval-1@2x.png" class="oval" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                    <div class="pearltrees">
                        Pearltrees
                    </div>
                    <div class="serviceexterne">
                        Service externe
                    </div>
                    <img anima-src="./img/pearltrees-rectangle.png" class="rectangle" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                    <a href="pearltrees.html">
                        <img anima-src="./img/classe-fullscreen-enter-sm@2x.png" class="fullscreenentersm" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                    </a>
                </div>
                <div class="group2">
