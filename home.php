...
<html>
    <head>
					<title>SchoolConnect | Home</title>
            ...
            <div style="width: 1280px; height: 100%; position:relative; margin:auto;">
                <div class="group27">
                    ...
                    <div class="group28">
                        ...
                        <img anima-src="./img/home-rectangle-1@2x.png" class="rectangle3" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                        <img anima-src="./img/classe-rectangle-2.png" class="rectangle4" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                        <div class="rectangle5">
                        </div>
                        <div class="proprietesidansu">
                            Propriete: Si dans une equation au <br />moins un des facteurs est un nombre nul<br />alors l'equation est forcement Ã©gale a 0<br /><br />          Exemple:   x(5+5) = 0<br /><br />Dans l'exemple ci dessus x est forcement <br />egal a 0 puisque 5+5 est Ã©gal a 10 <br />Or 0x10 = 0<br />Donc l'equation est un produit nul et <br />x est Ã©gal a 0.
                        </div>
                        <div class="group20">
                            <div class="mathematiques">
                                Mathematiques
                            </div>
                            <div class="a8h109h05">
                                8h10-9h05
                ...
                <div class="group26">
                    <img anima-src="./img/home-rectangle-3.png" class="rectangle" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                    <div class="events">
                        <img anima-src="./img/messagerie-rectangle-4.png" class="rectangle1" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                        <div class="group24">
                            <div class="rectangle2">
                            </div>
                            <div class="group21">
                ...
                <div class="group19">
                    <img anima-src="./img/messagerie-rectangle-5.png" class="rectangle" src="data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw=="/>
                    <div class="group18">
                        <div class="group14">
                            <div class="group13">
																													<?php
...
{
	echo '<div class="rectangle1" style="margin-top: 0px;margin-bottom: 40px;"> <div class="mathematiques" > ' . htmlspecialchars($donnees['matiere']) . '</div> <div class="donnelejeudi611" >  Pour le '  . htmlspecialchars($donnees['pourle']) . '</div> <div class"fairelactivite1p" style="padding-left: 15px;padding-top: 70px;white-space: nowrap;text-overflow: ellipsis;overflow: hidden;">' . htmlspecialchars($donnees['contenu']) . '</div> </div>';
...
?>
                    ...
                    <div class="bonjourcosme">
                        Bonjour, <?=$nickname?> !
                    </div>
                    <div class="vosdevoirs">
                        Vos Devoirs
                    </div>
                </div>
                <div class="group10">
                ...
                <div class="group12">
                    ...
                    <div class="rectangle" style="height=568px;">
                    </div>
                    <div class="label2">
                       <form action="minichat_post_home.php" method="post">
																								<input type="text" name="message" id="message" placeholder="Message" style="width: 205px;"/>
																								<input type="text" name="chatpseudo" value="<?=$nickname?>" />
																								<input type="text" name="classchat" value="<?=$classe?>"/>
																								<input type="submit" value="Envoyer" style="padding-left: 0px;margin-left: 390px;"/>
																							</form>
...
// Récupération des 10 derniers messages
$reponse = $bdd->query('SELECT chatpseudo, classchat, message FROM minichat ORDER BY ID ASC LIMIT 0, 100');

// Affichage de chaque message (toutes les données sont protégées par htmlspecialchars)
while ($donnees = $reponse->fetch())
{
	echo '<div class="others" > <div class="name" >' . htmlspecialchars($donnees['chatpseudo']) . ' </div>'  . htmlspecialchars($donnees['message']) . '</div>';
